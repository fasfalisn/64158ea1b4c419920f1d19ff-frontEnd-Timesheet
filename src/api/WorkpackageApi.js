...
export default class WorkpackageApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getByParamsworkpackage operation.
     * @callback module:api/WorkpackageApi~getByParamsworkpackageCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/Workpackage>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/WorkpackageApi~getByParamsworkpackageCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Workpackage>}
     */
    getByParamsworkpackage(filter, callback) {
      let postBody = null;
      // verify the required parameter 'filter' is set
      if (filter === undefined || filter === null) {
        throw new Error("Missing the required parameter 'filter' when calling getByParamsworkpackage");
      }
