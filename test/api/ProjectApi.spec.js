...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TempApi.ProjectApi();
  });
  ...
  describe('ProjectApi', function() {
    ...
    describe('getAllproject', function() {
      it('should call getAllproject successfully', function(done) {
        //uncomment below and update the code to test getAllproject
        //instance.getAllproject(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getByParamsproject', function() {
      it('should call getByParamsproject successfully', function(done) {
        //uncomment below and update the code to test getByParamsproject
        //instance.getByParamsproject(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
